...
<section>
    <header class="layout-head">
        ...
        <dl class="wjx-stage-head">
            <a class="pull-left question-title" style="color: #4d4d4d;" href="#">业委会及开发商满意度调查</a>
        </dl>
    </header>
</section>
<section class="changeData">
    <form name="personal" id="personal" method="get" action="/question/perfect-develop">
        <div class="form">
            <label class="clearfix">
                <span class="form-span">联系电话</span>
                <div class="form-ctr"><input name="phone" type="text" placeholder="请填写手机号码" value=""></div>
            </label>
