...
foreach ($dataProvider->getModels() as $model) { ?>
    <div class="repair-lists">
        <div class="list-cell">
            <div class="new-info" data-go="/repair/view?id=<?= $model->id ?>">
                <ul>
                    <li>
                        <h4>
                    ...
                    <ul>
                        ...
                        <?php } else {?>
                            ...
                            <li class="bottom-ul-li1">
                                ...
                                <button class="bottom-right" data-go="/repair/cancel?id=<?= $model->id ?>">取消</button>
                                <?php } ?>

                                <?php if( in_array($model->status, [\common\models\Repair::STATUS_DONE, 7])){?>
                                    <button class="bottom-right" data-go="/repair/customer-evaluation?id=<?= $model->id ?>">评价</button>
                                <?php } ?>
