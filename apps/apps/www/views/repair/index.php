...
<?php \components\za\ActiveForm::begin(); ?>
    ...
    <?php if($flowStyleID == 'w'){?>
        ...
        <div class="identity-choice inline">
            <div <?php if($site == Repair::SITE_TYPE_2) echo 'class="hover"';?> data-d="2" <?php if($site != Repair::SITE_TYPE_2) echo "data-go='/repair?flowStyleID=w&site=". Repair::SITE_TYPE_2 ."'"?>>
                <div>个人报修</div>
                <i></i>
            </div>
            <div <?php if($site == Repair::SITE_TYPE_1) echo 'class="hover"';?> data-d="1" <?php if($site != Repair::SITE_TYPE_1) echo "data-go='/repair?flowStyleID=w&site=". Repair::SITE_TYPE_1 ."'"?>>
                <div>公共维修</div>
                <i></i>
            </div>
        </div>
    ...
    <?= Html::hiddenInput($repair->formName() . '[flow_style_id]', $flowStyleID, ['placeholder' => '请输入真实姓名', 'data-required' => true]) ?>
 ...
 */ ?>
    ...
    <div class="form-group">
        <?= Html::textInput($repair->formName() . '[tel]', empty($_user->phone)?'':$_user->phone, ['placeholder' => '请输入真实手机号码', 'data-required' => true]) ?>
        <label>手机号码</label>
    </div>
