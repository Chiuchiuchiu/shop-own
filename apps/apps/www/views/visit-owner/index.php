    ...
    <div class="pd">
        ...
        <div class="pure-form">
            ...
            <div class="form-group phone">
                <input type="text" name="" disabled value="<?= $_user->phone ?>" placeholder="请输入手机号码">
                <input type="hidden" name="phone" value="<?= $_user->phone ?>">
            </div>
...
<script>
    $(function(){
        $('#getCode').on('click', function () {
            ...
            app.showLoading();
            $.getJSON('/member/auth-code?phone=' + phone, function (res) {
                app.hideLoading();
                if (res.code === 0) {
