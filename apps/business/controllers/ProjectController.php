...
use apps\pm\models\PmManagerGroup;
use apps\business\service\Service;
...
class ProjectController extends Controller
{
    ...
    {
        $projectRegionId = $this->get('project_region_id');
            ...
            if ($projectExists) {
                ...
                if ($model->load($data) && $model->save()){
                    ...
                    if ($pmManagerGroupModel->save()){
                        ...
                        $pmManagerModel->real_name = 'business';
                        $pmManagerModel->name = 'business_'.$model->url_key;
