...
$from = \components\inTemplate\widgets\ActiveForm::begin(['method' => 'get', 'action' => \yii\helpers\Url::to(['door-control/lxj'])])
...
?>
    ...
    <div class="col-lg-12">
        ...
        echo \yii\helpers\Html::a(
            '导出当前数据报表',
            ['lxj-export', 'house_id' => $house_id, 'RangDateTime[startDate]'=>$dateTime->getStartDate(), 'RangDateTime[endDate]'=>$dateTime->getEndDate()],
...
<?= \components\inTemplate\widgets\IBox::widget(['content' => \yii\grid\GridView::widget([
    ...
    'columns' => [
        ...
        [
            'label' => '用户昵称/名',
            'format' => 'raw',
            'value' => function(\common\models\LxjLog $model){
