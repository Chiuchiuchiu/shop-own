...
class WxPayDataBase
{
	...
	**/
	...
	{	
		if(!$xml){
			throw new WxPayException("xml数据异常80！");
		}
        //将XML转为array
        //禁止引用外部xml实体
 ...
 *
 */
class WxPayJsApiPayData extends WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value
...
class WxRedPackData extends WxPayDataBase
{
...
class WxRedPackResults extends WxPayDataBase
{
    /**
     *
     * 检测签名
